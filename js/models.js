...
class StoryList {
  ...
  //user info is stored in global variable currentUser
...
class User {
  ...
  /** Mark a story as favorite for the user */
  ...
  async removeFavorite(story) {
    ...
    let index;
    for (let stry of this.favorites) {
      if (stry.storyId === story.storyId) {
        index = this.favorites.indexOf(stry);
      }
    }
